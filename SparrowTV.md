...
USBコネクタはESP32-C3-WROOM-02ではなく、CH9329Ⅱ接続されています。PCと接続すると、USBキーボードとして認識します。USBキーボードとして認識することを確認してください。
...
CircuitPythonを再度インストールする必要がある場合には、ESP32の書き込み方法を調べてみてください。EN、IO0を制御することで書き込みを行うことができます。
