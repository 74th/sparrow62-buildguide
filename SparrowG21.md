...
- 再度、USBストレージがマウントされるため、[./firmware/g21/GP2040-CE_0.7.7_SparrowG21.uf2](./firmware/g21/GP2040-CE_0.7.7_SparrowG21.uf2)を書き込む。
...
- [GP2040-ce v0.7.5 - SparrowG21 v1.1.0: gp2040ce-v0.7.5_sparrowg21.gp2040](./firmware/g21/gp2040ce-v0.7.5_sparrowg21.gp2040)
- [GP2040-ce v0.7.7 - SparrowG21 v1.1.0: gp2040ce-v0.7.7_sparrowg21.gp2040](./firmware/g21/gp2040ce-v0.7.7_sparrowg21.gp2040)（こちらを適用しても、Peripheral Mappingの設定が適用されないのを確認しています。Peripheral Mappingの設定は手動で行ってください）
